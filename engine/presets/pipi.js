...
const DEFAULT_ACTIONS=[
  ...
  {id:'pointRight',label:'画面右翅指字',type:'point',asset:'point:right',side:'right',holdMs:1800},
...
function installPipiAssets(assets,baseURL=DEFAULT_ASSET_BASE) {
  ...
  assets.define('flight:up',{...copy(hover),durations:hover.durations.map((_,i)=>i>=8&&i<24?18:27)},{baseURL});
  assets.define('flight:down',{...copy(hover),durations:hover.durations.map((_,i)=>i===0||i===16?220:32)},{baseURL});
}
